...
class JobOffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_offer" do
    assert_difference('JobOffer.count') do
      post job_offers_url, params: { job_offer: { address: @job_offer.address, description: @job_offer.description, position: @job_offer.position, salary: @job_offer.salary, skillsmodality: @job_offer.skillsmodality } }
    end
  ...
  test "should update job_offer" do
    patch job_offer_url(@job_offer), params: { job_offer: { address: @job_offer.address, description: @job_offer.description, position: @job_offer.position, salary: @job_offer.salary, skillsmodality: @job_offer.skillsmodality } }
